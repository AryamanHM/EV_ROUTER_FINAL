...
def display_route_details(route_data):
    ...
    if "routes" in route_data:
        ...
        total_duration = duration + (get_charging_duration(route['sections'])*60)
        print(f"Total Duration: {total_duration:.2f} seconds")
        print(f"Total On Road Duration: {duration:.2f} seconds")
        print(f"Charging Duration: {get_charging_duration(route['sections'])*60:.2f} seconds")
...
if __name__ == '__main__':
    origin = "12.9767936,77.590082"  # Replace with your origin coordinates
    destination = "28.6273928,77.1716954"  # Replace with your destination coordinates
